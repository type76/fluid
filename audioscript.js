...
//bgfx
function bgfx(xmove, ymove, dx, dy, xcolor ) {
config.SPLAT_RADIUS = 0.005;
const color = generateColor();
color.r *= 10.0;
color.g *= 10.0;
color.b *= 10.0;
splat(xmove+15, ymove+15, dx, dy, xcolor);
}
...
// update output labels
let output = document.querySelector("#masterGainOutput");
output.value = value;
}
...
// update output labels
let output = document.querySelector("#balanceOutput");
output.value = value;
}
